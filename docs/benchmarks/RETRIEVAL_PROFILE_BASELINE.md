...
```
   ...
   ncalls  tottime  percall  cumtime  percall filename:lineno(function)
       40    0.323    0.008   15.038    0.376 src/epistemos/core/__init__.py:1086(search)
       40    1.367    0.034   14.714    0.368 src/epistemos/retrieval/__init__.py:85(search)
   400000    1.207    0.000    5.140    0.000 src/epistemos/retrieval/__init__.py:157(_score_one)
   400000    0.966    0.000    2.947    0.000 src/epistemos/retrieval/__init__.py:220(_build)
   400040    0.141    0.000    2.458    0.000 src/epistemos/storage/sqlite.py:201(objects)
 ...
 13200040    1.499    0.000    1.499    0.000 {method 'get' of 'dict' objects}
  ...
  2000000    0.741    0.000    1.305    0.000 src/epistemos/_util.py:68(parse_instant)
   ...
   400000    0.209    0.000    1.211    0.000 src/epistemos/temporal/__init__.py:50(believed_at)
   800000    0.261    0.000    0.928    0.000 src/epistemos/temporal/__init__.py:32(instant_in_interval)
   400000    0.557    0.000    0.892    0.000 src/epistemos/retrieval/__init__.py:250(_why)
   400000    0.248    0.000    0.861    0.000 src/epistemos/retrieval/__init__.py:41(_object_text)
   400000    0.201    0.000    0.676    0.000 src/epistemos/temporal/__init__.py:43(valid_at)
   400040    0.274    0.000    0.635    0.000 src/epistemos/retrieval/__init__.py:35(_tokens)
  ...
  1600000    0.253    0.000    0.351    0.000 src/epistemos/retrieval/__init__.py:183(<genexpr>)
   400000    0.345    0.000    0.345    0.000 <string>:2(__init__)
  1600000    0.231    0.000    0.329    0.000 src/epistemos/retrieval/__init__.py:148(<genexpr>)
   800040    0.152    0.000    0.314    0.000 src/epistemos/_util.py:57(now_utc)
